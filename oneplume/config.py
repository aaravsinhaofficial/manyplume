...
plumezoo = '/Users/aaravsinha/plume/plumezoo/latest/fly/memory/'  # Agent models and eval data
basedir = '/Users/aaravsinha/plume/plume2'                              # Base directory

datadir = '/Users/aaravsinha/plume/plumedata/'  
if MACHINE == 'mycroft':
	datadir = '/Users/aaravsinha/plume/plumedata/'  
